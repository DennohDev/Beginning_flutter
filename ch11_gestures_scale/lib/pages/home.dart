...
class _HomeState extends State<Home> {
  ...
  //This gesture is called once when the user starts to move or scale the image
  // This method populates _startLastOffset, _lastOffset and _lastScale variables
  ...
  // This gesture is called when the user is moving or scaling the image
  ...
  //_onDoubleTap gesture is called when the user is double Tapping the screen
  void _onDoubleTap() {
    print('onDoubleTap');

    //Calculate current scale and populate the _lastScale with current scale
    //if current scale is greater than 16 times the original image, reset scale to default 1.0
